            ...
            {!isGuardLogin ? (
              <div className="space-y-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-white hover:bg-gray-50 text-gray-800 font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed group"
                >
                  {loading ? (
