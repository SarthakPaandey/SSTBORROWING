        ...
        <div className="relative flex items-center justify-center">
          {isGalaxy ? (
            <div className="relative h-24 w-24">
              ...
              >
                <div className="absolute -top-2 left-1/2 -translate-x-1/2"><FluentEmoji emoji="🏏" size="sm" /></div>
                <div className="absolute top-1/2 -right-2 -translate-y-1/2"><FluentEmoji emoji="⚽" size="sm" /></div>
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2"><FluentEmoji emoji="🎾" size="sm" /></div>
                <div className="absolute top-1/2 -left-2 -translate-y-1/2"><FluentEmoji emoji="💻" size="sm" /></div>
              </div>
              {/* Inner orbit */}
              <div
              ...
              >
                <div className="absolute -top-1.5 left-1/2 -translate-x-1/2"><FluentEmoji emoji="🏸" size="xs" /></div>
                <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2"><FluentEmoji emoji="📚" size="xs" /></div>
              </div>
              ...
              <div className="absolute inset-[24px] rounded-full bg-bg-dark flex items-center justify-center">
                <div
                  className="drop-shadow-[0_0_14px_rgba(13,140,232,0.6)] animate-spin-slow"
                  style={{ animationDuration: '18s' }}
                >
                  <FluentEmoji emoji="🏟️" size="lg" />
                </div>
              </div>
            </div>
          ) : (
